    ...
    <CRow>
      <CCol xs={12}>
        <CCard xs={12} className="mb-4">
          ...
          <CCardBody>
            <CCardText>
              Upload a CSV file containing your data. The file must be a
              spreadsheet with two columns, where the first column contains the
              dates/times, and the second column contains the y values. Download
              and try forcasting with the example files below!
            </CCardText>

            <CCardText>Example Files:</CCardText>
            <CRow className="justify-content-start">
              <DownloadButton
                name={"Air Passengers"}
                url={"http://localhost:5050/api/download-file1"}
              />
              <DownloadButton
                name={"Retail Sales"}
                url={"http://localhost:5050/api/download-file2"}
              />
              <DownloadButton
                name={"Peyton Manning"}
                url={"http://localhost:5050/api/download-file3"}
              />
            </CRow>
          </CCardBody>
        </CCard>
